...
export function TechnologiesSection() {
  ...
  const technologies = [
    ...
    { name: "Lovable", image: "/images/lovable.png" },
    { name: "Emergent", image: "/images/emergent.png" },
    { name: "Blackbox", image: "/images/blackbox.png" },
    { name: "Devin", image: "/images/devin.png" },
